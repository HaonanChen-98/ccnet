...
parser.add_argument("--dataset", type=str,
                    # default='EP',
                    default='EP,MSL,SMD_selected,ASD,SMAP,SWaT_cut,DASADS',
...
parser.add_argument("--model", type=str, default='DeepSVDDTS', help="")
...
modules_list = dir(deepod.models)
print(modules_list)
